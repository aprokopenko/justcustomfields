...
class JustField_DatePicker extends core\JustField {
	...
	public function field() {
		...
		<div id="jcf_field-<?php echo $this->id; ?>"
			...
			<div>
				<input id="<?php echo $this->get_field_id( 'val' ); ?>"
	...
	public function form() {
		...
		<p><label for="<?php echo $this->get_field_id( 'show_monthes' ); ?>"><input class="checkbox"
																					id="<?php echo $this->get_field_id( 'show_monthes' ); ?>"
																					name="<?php echo $this->get_field_name( 'show_monthes' ); ?>"
																					type="checkbox"
																					value="1" <?php echo $show_monthes; ?> /> <?php _e( 'Show month/year select boxes', \JustCustomFields::TEXTDOMAIN ); ?>
			</label></p>
		<p>
			<label for="<?php echo $this->get_field_id( 'date_format' ); ?>"><?php _e( 'Date format:', \JustCustomFields::TEXTDOMAIN ); ?></label>
