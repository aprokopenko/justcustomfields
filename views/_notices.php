<?php if ( ! empty( $this->_messages ) ) : ?>
	<?php foreach ( $this->_messages as $message ) : ?>
		<div class="updated notice is-dismissible below-h2 ">
			...
			<?php echo( $wp_version < 4.2 ? '' : '<button type="button" class="notice-dismiss"><span class="screen-reader-text">' . esc_html__( 'Dismiss this notice.', \JustCustomFields::TEXTDOMAIN ) . '</span></button>' ) ?>
		</div>
	<?php endforeach; ?>
<?php endif; ?>
