	...
	<div class="jcf_inner_box">
		...
		<div class="jcf_inner_content">
			<fieldset class="shortcode_usage">
				<legend><?php _e('Inside the Editor', \JustCustomFields::TEXTDOMAIN); ?></legend>
				<span class="fieldset-description"><?php _e('To insert the value into your post editor, please copy and paste the code examples below to your editor.', \JustCustomFields::TEXTDOMAIN); ?></span>
				...
				<small><?php _e('optional parameters: class="myclass" id="myid" post_id="123" label="yes"', \JustCustomFields::TEXTDOMAIN); ?></small><br /><br />
			</fieldset>
			<fieldset class="template_usage">
				<legend><?php _e('Inside your Templates', \JustCustomFields::TEXTDOMAIN); ?> </legend>
				<span class="fieldset-description"><?php _e('To print the value or label inside your template (for example in single.php) please use the examples below:', \JustCustomFields::TEXTDOMAIN); ?></span>
