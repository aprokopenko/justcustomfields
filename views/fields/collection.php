<table class="wp-list-table widefat fixed collection-fields-table" cellspacing="0">
				...
				<form action="#" method="post" class="jcform_add_collection_field">
					<fieldset>
						...
						<input type="submit" class="button show_modal" name="add_field"
							   value="<?php _e( 'Add', \JustCustomFields::TEXTDOMAIN ); ?>"/>
	...
	<?php if ( ! empty( $collection['fields'] ) && is_array( $collection['fields'] ) ) : ?>
		<?php foreach ( $collection['fields'] as $field_id => $field ) : ?>
			<tr id="collection_field_row_<?php echo $field_id; ?>">
				...
				<td>
					<strong><a href="#"
							   rel="<?php echo $field_id; ?>"><?php echo esc_html( $field['title'] ); ?></a></strong>
					<div class="row-actions">
							<span class="edit_collection">
								<a href="#" rel="<?php echo $field_id; ?>"
								   data-collection_id="<?php echo $collection_id; ?>"><?php _e( 'Edit', \JustCustomFields::TEXTDOMAIN ); ?></a>
							</span> |
						<span class="delete_collection" data-collection_id="<?php echo $collection_id; ?>"><a href="#"
																											  rel="<?php echo $field_id; ?>"
																											  data-collection_id="<?php echo $collection_id; ?>"><?php _e( 'Delete', \JustCustomFields::TEXTDOMAIN ); ?></a></span>
					</div>
				</td>
	...
	<?php else : ?>
		<tr>
			<td colspan="5"
				align="center"><?php _e( 'Please create fields for this collection', \JustCustomFields::TEXTDOMAIN ); ?></td>
		</tr>
	<?php endif; ?>
	</tbody>
</table>